...
export const EmbozzScreen: React.FC<EmbozzScreenProps> = ({ navigation }) => {
  ...
  const renderSeriesTab = (series: any) => {
    ...
    // Strip out "Embozz" for cleaner tab labels
    let tabLabel = series.name.replace(/^Embozz\s+/i, "");
    if (!tabLabel || tabLabel.toLowerCase() === "embozz") {
      tabLabel = "All";
    }
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <SafeAreaView edges={["top"]}>
          <View style={styles.headerContent}>
            ...
            {/* Title */}
            <Text style={styles.title}>Embozz Series</Text>
          </View>
        </SafeAreaView>
      </ImageBackground>
      ...
      <View style={styles.contentCard}>
        ...
        specificSeriesTabs[0].name !== "Embozz" ? (
