...
const getSubSeriesImage = (name: string) => {
  return { uri: "https://iglmngvjazarthujdofo.supabase.co/storage/v1/object/public/category-images/doors/teak-veneer.png" };
};

interface TeakVeneerScreenProps {
  navigation: any;
}

export const TeakVeneerScreen: React.FC<TeakVeneerScreenProps> = ({
  navigation,
}) => {
  ...
  const renderSeriesTab = (series: any) => {
    ...
    // Strip out "Teak Veneer" for cleaner tab labels
    let tabLabel = series.name.replace(/^Teak Veneer\s+/i, "");
    if (!tabLabel || tabLabel.toLowerCase() === "teak veneer") {
      tabLabel = "All";
    }
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <SafeAreaView edges={["top"]}>
          <View style={styles.headerContent}>
            ...
            {/* Title */}
            <Text style={styles.title}>Teak Veneer Series</Text>
          </View>
        </SafeAreaView>
      </ImageBackground>
      ...
      <View style={styles.contentCard}>
        ...
        specificSeriesTabs[0].name !== "Teak Veneer" ? (
