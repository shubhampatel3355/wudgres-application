...
export const EspialScreen: React.FC<EspialScreenProps> = ({ navigation }) => {
  ...
  const renderSeriesTab = (series: any) => {
    ...
    // Strip out "Espial" for cleaner tab labels
    let tabLabel = series.name.replace(/^Espial\s+/i, "");
    if (!tabLabel || tabLabel.toLowerCase() === "espial") {
      tabLabel = "All";
    }
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <SafeAreaView edges={["top"]}>
          <View style={styles.headerContent}>
            ...
            {/* Title */}
            <Text style={styles.title}>Espial Series</Text>
          </View>
        </SafeAreaView>
      </ImageBackground>
      ...
      <View style={styles.contentCard}>
        ...
        specificSeriesTabs[0].name !== "Espial" ? (
