...
export const PlywoodDetailScreen: React.FC<ProductDetailScreenProps> = ({
  navigation,
  route,
}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView bounces={false} contentContainerStyle={styles.scrollContent}>
        ...
        {/* Product Information */}
        <View style={styles.infoSection}>
          <Text style={styles.productTitle}>BWR (MELAMINE BONDED)</Text>
        </View>
          ...
          <View style={styles.specificationsContainer}>
            <View style={[styles.table, { marginTop: 12, marginBottom: 24 }]}>
              ...
              >
                ...
                >
                  NEEM WOOD / EUCALYPTUS WOOD / POPLAR WOOD IN PLYWOOD
                </Text>
              </View>
              {/* PLY FACE */}
              <View
