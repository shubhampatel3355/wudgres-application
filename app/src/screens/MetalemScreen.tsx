...
const getSubSeriesImage = (name: string) => {
  return { uri: "https://iglmngvjazarthujdofo.supabase.co/storage/v1/object/public/category-images/doors/metalem.png" };
};

interface MetalemScreenProps {
  navigation: any;
}

export const MetalemScreen: React.FC<MetalemScreenProps> = ({ navigation }) => {
  ...
  const renderSeriesTab = (series: any) => {
    ...
    // Strip out "Metalem" for cleaner tab labels
    let tabLabel = series.name.replace(/^Metalem\s+/i, "");
    if (!tabLabel || tabLabel.toLowerCase() === "metalem") {
      tabLabel = "All";
    }
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <SafeAreaView edges={["top"]}>
          <View style={styles.headerContent}>
            ...
            {/* Title */}
            <Text style={styles.title}>Metalem Series</Text>
          </View>
        </SafeAreaView>
      </ImageBackground>
      ...
      <View style={styles.contentCard}>
        ...
        specificSeriesTabs[0].name !== "Metalem" ? (
